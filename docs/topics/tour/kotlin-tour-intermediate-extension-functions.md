...
<list columns="2" id="tour-nav">
  <li>
    <a type="button" href="kotlin-tour-null-safety.md" mode="outline" icon="arrow-left" icon-position="left">Previous step</a>
  </li>
  <li>
    <a type="button" href="kotlin-tour-intermediate-scope-functions.md" mode="classic" icon="arrow-right" icon-position="right">Next step</a>
  </li>
</list>
